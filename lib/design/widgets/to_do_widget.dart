...
class ToDoWidgetOption extends StatelessWidget {
  final Function edit;
  final DatabaseHelper dbHelper;
  final int id;
  final String text;
  ...
  ToDoWidgetOption({required this.hasCheckbox, required this.id, required this.text, required this.dbHelper, required this.edit, required this.complete, required this.refresh});
